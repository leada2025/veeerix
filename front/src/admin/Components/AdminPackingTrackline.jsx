...
const handleStepUpdate = async (designId, newStep) => {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-10 bg-white p-6 rounded shadow">
      <h2 className="text-xl font-bold text-[#d1383a] mb-4">Packing Tracking Progress</h2>
  ...
  <strong>Customer:</strong> {item.customerId?.name || "Unknown"}
         ...
         <p><strong>Current Step:</strong> {statuses[parseInt(item.trackingStep)]}</p>


          <select
            value={item.trackingStep}
