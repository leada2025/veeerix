...
const fetchRequests = async (resetPage = false) => {
  try {
            ...
            {currentItems.map((req) => {
              ...
              return (
                ...
                >
                    ...
                    {new Date(req.createdAt || req._id).toLocaleDateString()}{" "}
                    {new Date(req.createdAt || req._id).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                  </td>
